...
There is one row per flow doc (27 total): 16 consumer, 9 admin, 2 ops.
...
| List / Post a Property (Owner Wizard) | [list-property-wizard.md](./flows/consumer/list-property-wizard.md) | owner (maker), admin (checker) | 3 Owner Listings, 4 Properties (Admin), 6 Verification & KYC, 16 Documents, 26 Share a Flat | listings/properties, rooms, share_flat_requests, aadhaar_verifications, property_reviews, documents | Yes |
...
| Share a Flat (Flatmates, Rooms & Groups) | [share-a-flat.md](./flows/consumer/share-a-flat.md) | buyer/tenant (seeker + host), admin/ops | 26 Share a Flat | share_flat_requests, share_groups, rooms | Yes |
