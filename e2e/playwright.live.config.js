...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      VITE_API_DOMAINS:
        'auth,property,notification,conversation,review,support,report,visit,contact,saved,savedSearch,plan,deal,rent,flatmate,serviceRequest,verification,document',
      VITE_API_BASE: '/api',
