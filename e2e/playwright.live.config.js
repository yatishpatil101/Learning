...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      VITE_API_DOMAINS:
        'auth,property,notification,conversation,review,support,report,visit,contact,saved,savedSearch,plan,deal,rent,flatmate,serviceRequest,verification,document,society,photo,fees,team,settings,ticket,referral,users,staffActivity,propertyReview,outreach,content,locality',
      VITE_API_BASE: '/api',
