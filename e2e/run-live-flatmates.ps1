...
# database punenest_e2e_fm2. The backend for this lane must already be running with
...
# 'punenest_e2e', so without this the run resets a database the backend on :8095 is not
...
$env:E2E_DB_NAME = 'punenest_e2e_fm2'
