...
const VERIFIED_SALE = 'P5013';   // 1 BHK Flat in Baner (buy), approved, ownershipVerified: true
const UNVERIFIED_SALE = 'P5008'; // 2 BHK Penthouse in Baner (buy), approved, ownershipVerified: false
