...
import com.punenest.api.common.payments.CheckoutTtl;
 ...
 * deliberately in {@code com.punenest.api.provider} — can call directly. That keeps the assertion on
...
class CashfreeOrderExpiryTest {
    ...
    void nanosecondsAreTruncated() {
        Map<String, Object> body = CashfreePaymentGateway.orderRequest(
                "pn_1", 2499L, "sub_1", "cust_1", "9800000000",
    ...
    void theExistingFieldsSurvive() {
        ...
        assertThat(body.get("order_id")).isEqualTo("pn_1");
    ...
    private static Map<String, Object> body() {
        return CashfreePaymentGateway.orderRequest(
                "pn_1", 2499L, "sub_1", "cust_1", "9800000000", TTL.expiryFrom(NOW));
    }
}
