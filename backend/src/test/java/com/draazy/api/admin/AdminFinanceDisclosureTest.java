 ...
 * {@code draazy.finance.*} with a {@code :false} fallback baked into the {@code @Value}.
 *
 ...
 * {@code draazy.finance.refund-measured} in the deployed file would leave this test green and the
