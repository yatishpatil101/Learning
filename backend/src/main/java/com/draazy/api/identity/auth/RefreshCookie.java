 ...
 *       ({@code draazy.com} serving the UI and proxying {@code /api} to this service), or sibling
 *       subdomains ({@code www.draazy.com} → {@code api.draazy.com}), which is cross-origin but
 ...
 *       com.draazy.api.common.config.CookieDeliveryCheck} refuses to start the application when
 ...
 * someone else can claim — can send {@code Set-Cookie: draazy_rt=…; Domain=.draazy.in}, and
 ...
 * com.draazy.api.common.config.CookieDeliveryCheck} blesses is exactly the shape where such
 * siblings exist.
 *
...
public class RefreshCookie {
     ...
     */
    public static final String NAME = "draazy_rt";
     ...
     */
    public static final String HINT_NAME = "draazy_session";
    ...
    RefreshCookie(JwtProperties jwt,
            @Value("${draazy.security.refresh-cookie.secure:true}") boolean secure,
