...
public class OfferController {
     ...
     * @throws com.draazy.api.common.error.ConflictException  when blocked by a closed deal or duplicate
     */
     ...
     * counter an offer.
     *
     * @throws com.draazy.api.common.error.NotFoundException when the offer is unknown or
     *                                                          the caller is not a participant
     * @throws com.draazy.api.common.error.ConflictException  on an illegal state transition
     */
