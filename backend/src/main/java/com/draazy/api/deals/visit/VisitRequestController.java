...
public class VisitRequestController {
     ...
     *
     * @throws com.draazy.api.common.error.NotFoundException when the visit is unknown or
     *                                                          the caller is not a participant
     * @throws com.draazy.api.common.error.ForbiddenException when the caller is a participant
