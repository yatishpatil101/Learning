 ...
 * has no Draazy account, so whoever holds the string can read someone's title deeds. That makes
...
public final class ShareTokens {
     ...
     *
     * <p>Deliberately <em>not</em> {@code Authorization}: {@link com.draazy.api.security.JwtAuthFilter}
