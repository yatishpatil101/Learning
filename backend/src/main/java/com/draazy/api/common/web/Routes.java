...
public final class Routes {
     ...
     * Draazy is worth signing up for, so putting them behind a token would defeat their purpose.
     */
     ...
     * Draazy sells and for how much. Bolting the plan prices onto {@code /fees} would have put
    ...
    public static final class MeManagedProperties {
        ...
        /**
         * Rent the owner recorded as received outside Draazy's payment rail — {@code GET} the
     ...
     * Draazy. There is no {@code propId} to put in the path.
     *
    ...
    public static final class Engagement {
         ...
         *
         * <p>Until this existed the flatmate shortlist was {@code draazyFlatmateSaved} in
    ...
    public static final class Documents {
         ...
         * has no Draazy account; the unguessable, expiring token is the credential.
         */
    ...
    public static final class MeDocumentRequests {
         ...
         * {@link com.draazy.api.documents.request.DocumentRequestMapper#toRequesterDto} for why
