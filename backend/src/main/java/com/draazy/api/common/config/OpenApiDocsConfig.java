...
/**
 * Serves API documentation for the Draazy modular monolith.
 *
 * <p>The hand-authored OpenAPI 3.1 contract lives at
 * {@code src/main/resources/static/openapi/draazy-api.yaml} and is served as a
 * static asset at {@code /openapi/draazy-api.yaml}. Swagger UI (bundled via the
