...
public class ContactController {
     ...
     *
     * @throws com.draazy.api.common.error.NotFoundException when the listing does not exist
     */
     ...
     *
     * @throws com.draazy.api.common.error.VerificationRequiredException on that single opt-in path
     */
