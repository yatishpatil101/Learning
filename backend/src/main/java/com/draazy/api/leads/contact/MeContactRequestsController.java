...
public class MeContactRequestsController {
     ...
     *
     * @throws com.draazy.api.common.error.NotFoundException when the id is unknown or foreign
     * @throws com.draazy.api.common.error.ConflictException when the request was already answered
     */
