...
/**
 * One month of rent an owner recorded as received outside Draazy's payment rail (V120).
 *
 * <p>The owner's own assertion that cash or a bank transfer we never saw arrived. Draazy has no
