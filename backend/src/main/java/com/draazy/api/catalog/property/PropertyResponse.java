...
public record PropertyResponse(
         ...
         * everyone else ({@link com.draazy.api.common.trust.PrivateFieldVisibility}).
         *
         * <p>This field carries the flat number because {@link
         * com.draazy.api.catalog.listing.AddressKey} needs the unit token to tell one flat from
         ...
         * (V79, {@link com.draazy.api.common.trust.PrivateFieldVisibility}).
         *
         ...
         * every other audience ({@link com.draazy.api.common.trust.BackOfficeVisibility}).
         *
     ...
     *                      {@link com.draazy.api.common.trust.OutreachCounts}. Still deliberately
