package com.draazy.api.moderation.society;

import com.draazy.api.common.audit.AuditService;
import com.draazy.api.common.error.NotFoundException;
import com.draazy.api.engagement.society.SocietyAnswerRepository;
import com.draazy.api.engagement.society.SocietyBoardItemRepository;
import com.draazy.api.engagement.society.SocietyContributionReplyRepository;
import com.draazy.api.engagement.society.SocietyContributionRepository;
import com.draazy.api.engagement.society.SocietyQuestionRepository;
import com.draazy.api.moderation.report.ReportTargetTypes;
...
public class SocietyContentModerationService {
    ...
    private static UUID parseId(String token) {
        return com.draazy.api.common.web.Ids.parseUuid(token)
