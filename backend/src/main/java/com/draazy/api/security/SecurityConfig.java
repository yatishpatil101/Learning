 ...
 * {@code draazy_rt} ({@link com.draazy.api.identity.auth.RefreshCookie}). Disabling CSRF is
 ...
 * {@link com.draazy.api.identity.auth.RefreshOriginGate}, which refuses to rotate for an origin we
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,
                                ...
                                // What Draazy charges for its own products (contract:
                        ...
                        // locality map of what Draazy is short of. Write-only is the correct
                        ...
                        // Draazy is worth an account needs to see whether anyone is actually
                        ...
                        // the link is forwarded to a lawyer or a banker with no Draazy account;
