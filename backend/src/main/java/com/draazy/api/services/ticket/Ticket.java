...
public class Ticket extends VersionedEntity {
    ...
    /** One of {@link com.draazy.api.security.Teams}; the V7 CHECK rejects anything else. */
    @Column(name = "team")
    @Setter
    private String team;
     ...
     * com.draazy.api.deals.deal.Deal} already holds {@code agreedPrice} for exactly that. Adding
