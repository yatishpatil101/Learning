...
public class ServiceRequest extends VersionedEntity {
    ...
    /** One of {@link com.draazy.api.services.request.ServiceRequestTypes} — the desk's word. */
    @Column(name = "type", nullable = false, updatable = false)
    private String type;

    /**
     * The ops desk that works this request (D44). One of {@link com.draazy.api.security.Teams}.
     *
