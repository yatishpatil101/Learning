 ...
 *
 * <p>The counterparty's mobile is masked here even though {@code DealDto} reveals it. That reveal is
 * correct where it lives: the owner typed the number in themselves when they closed off-platform, so
 * showing it back to them discloses nothing. An operator did not type it and is owed no more of it
 * than of any other party's.
 *
 ...
 * @param counterpartyMobile <strong>always masked</strong>
