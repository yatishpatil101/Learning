 ...
 * has approved. This board is read by operators who are party to none of these conversations, so the
 * number is masked unconditionally — there is no status at which it becomes visible here, and no
 * parameter that unmasks it.
 *
 ...
 * @param requesterMobile <strong>always masked</strong> ({@code 98XXXXX210})
