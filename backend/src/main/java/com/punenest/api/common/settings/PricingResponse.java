 ...
 *
 * <p>Seven named fields rather than the {@code fees} settings block projected onto the wire. The
 ...
 * platform that must not be published. Naming the seven is what makes that a property of the type
 ...
 * @param gstPercent            GST on the convenience fee, as a percentage
 * @param rentPayPercent        the convenience fee on a rent payment, as a percentage
 */
