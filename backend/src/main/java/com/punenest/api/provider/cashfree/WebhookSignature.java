 ...
 *       ({@code punenest.providers.cashfree.enabled=true}), under any profile. Real money on a
...
public class WebhookSignature {
    ...
    public WebhookSignature(
            ...
            @Value("${punenest.providers.cashfree.enabled:false}") boolean gatewayEnabled,
    ...
    private static String liveDeploymentReason(boolean gatewayEnabled, Environment environment) {
        if (gatewayEnabled) {
            return "punenest.providers.cashfree.enabled=true";
        }
