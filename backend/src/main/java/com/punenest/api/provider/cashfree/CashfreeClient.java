 ...
 *
 * <p>Only constructed when {@code punenest.providers.cashfree.enabled=true}. With the flag off this
 ...
 * forever", which turns a vendor slowdown into exhausted request threads and takes PuneNest down
    ...
    CashfreeClient(CashfreeProperties props) {
        if (isBlank(props.appId()) || isBlank(props.secretKey())) {
            throw new IllegalStateException(
                    "punenest.providers.cashfree.enabled=true but app-id/secret-key are not set "
