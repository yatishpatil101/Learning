 ...
 * com.punenest.api.identity.user.erasure.ErasureRetention} is to {@code ErasureService}: it holds
 ...
 * {@link com.punenest.api.identity.user.erasure.ErasureRetention#knownGaps()} is neither exported
...
public final class DataExportScope {
     ...
     * com.punenest.api.identity.user.erasure.ErasureRetention#knownGaps()} is serialised into every
