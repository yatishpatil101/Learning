...
public class WriteRateLimitFilter extends OncePerRequestFilter {
     ...
     *
     * <p>{@code punenest.security.trusted-proxies=none} says nothing sits in front of this instance.
    ...
    private void warnIfProxied(HttpServletRequest request) {
        ...
        log.error("Request carried {} but punenest.security.trusted-proxies is 'none'. Anonymous "
