...
--
-- Until this seed the row did not exist server-side at all: R__seed_reference_data.sql seeds `fees`,
...
--     here even though R__seed_reference_data.sql's ON CONFLICT DO UPDATE would be indefensible for
