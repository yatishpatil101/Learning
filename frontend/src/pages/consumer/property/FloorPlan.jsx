...
export function FloorPlan({ p }) {
  ...
  return (
    <section className="fade-in section-mb">
      <h2 className="text-xl sm:text-2xl font-bold text-white mb-6 flex items-center gap-2"><Icon name="maximize" className="w-5 h-5 text-brand-teal-2" /> {t('property.floorPlan')}</h2>
