...
export function SimilarProperties({ p }) {
  ...
  return (
    <section ref={secRef} className="fade-in">
      <h2 className="text-xl sm:text-2xl font-bold text-white mb-6 flex items-center gap-2"><Icon name="layout-grid" className="w-5 h-5 text-brand-teal-2" /> {t('property.similarProperties')}</h2>
