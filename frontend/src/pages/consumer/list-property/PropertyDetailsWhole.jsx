...
import { facingOptions, overlookingOptions, ageOptions, floorOptions, totalFloorsOptions, furnitureItems,
  ...
  plotZoneOptions, openSidesOptions, plotUnitOptions, farmUnitOptions, waterSourceOptions } from './constants.js';
import { toDigits, toDecimal } from './sanitize.js';

export default function PropertyDetailsWhole({ form, set, onPropertyType, errors, isResidential, isLand, isCommercial, isHouse, toggleInArray, nextStep }) {
