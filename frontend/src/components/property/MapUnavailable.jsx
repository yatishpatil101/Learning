...
export default function MapUnavailable({ style, className = '', note }) {
  ...
  return (
    ...
    >
      <div className="text-center px-6 py-10">
        ...
        <p className="text-sm font-semibold text-gray-300">{note || t('pmap.mapUnavailable')}</p>
        <p className="mt-1 text-xs text-gray-500">{t('pmap.mapNotConfigured')}</p>
      </div>
    </div>
  );
}
