 ...
 * `record FaqResponse(String id, String question, String answer, String category)`, and
 * `ContentService.listFaqs()`, which filters archived rows server-side.
 */
 ...
 *
 * Nothing is dropped and nothing is renamed: the server's four fields are the service's four fields.
